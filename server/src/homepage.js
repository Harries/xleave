      ...
      <main>
        <div class="hero">
          ...
          <span class="eyebrow">Chrome AI 发帖与回复助手</span>
            ...
            <div class="cta">
              <a class="button primary" href="/register" rel="noreferrer">注册账号</a>
              <a class="button secondary" href="${GITHUB_URL}" rel="noreferrer">获取插件</a>
            </div>
            <p class="micro">自带 AI Key · 区分发帖与回复 · 不会自动发送 · 不读取图片或视频</p>
          </div>
        ...
        <section id="install">
          <div class="section-head">
            <h2>三步开始使用</h2>
            <p>注册账号、设置你自己的 AI Key，然后把访问 Token 填入插件即可。</p>
          </div>
          <div class="steps">
            <article class="step"><h3>注册并设置 AI Key</h3><p>在<a href="/register">用户中心</a>注册账号，进入个人中心设置自己的 OpenAI 或 DeepSeek API Key，并复制访问 Token。</p></article>
            <article class="step"><h3>安装并填写 Token</h3><p>下载解压插件，在 Chrome 扩展页开启开发者模式加载，点击插件图标把访问 Token 保存到浏览器本地。</p></article>
        ...
        <section>
          <div class="safety">
            ...
            <div class="checks">
              ...
              <div class="check"><b>03</b><span>你自己的 AI Key 经加密保存，仅用于向你选择的服务商发起请求。</span></div>
            </div>
          </div>
        </section>
      </main>
    ...
    <div class="wrap">
      ...
      <main>
        ...
        <div class="quick">
          ...
          <a href="#account"><strong>账号与 AI Key</strong><span>注册登录、访问令牌、自带 AI Key</span></a>
        ...
        <section id="account">
          <h2>账号、AI Key 与访问令牌</h2>
          <div class="faq">
            <details>
              <summary>如何开始使用？</summary>
              <p>先在<a href="/register">用户中心</a>注册账号并登录，进入个人中心设置自己的 OpenAI 或 DeepSeek API Key，复制访问 Token，再填入插件设置页。</p>
            </details>
            <details>
              <summary>Token 在哪里填写？</summary>
              <p>点击浏览器工具栏中的 XLeave 图标，进入设置页面，粘贴个人中心里的访问 Token 并保存。插件不需要填写用户 ID。</p>
            </details>
            <details>
              <summary>提示“请先设置 AI Token”怎么办？</summary>
              <p>你还没有在个人中心保存自己的 AI Key。登录<a href="/account">个人中心</a>，在“AI Token”一栏选择服务商并粘贴 API Key 后保存。DeepSeek 暂不支持联网发帖模式，发帖请使用 OpenAI。</p>
            </details>
            <details>
              <summary>提示“访问令牌无效”怎么办？</summary>
              <p>检查 Token 前后是否带有空格，并确认没有在个人中心轮换过 Token。Token 轮换后，旧 Token 会立即失效。</p>
            </details>
            <details>
              <summary>提示 IP 不在白名单怎么办？</summary>
              <p>你在个人中心设置过公网 IP 白名单，但当前 IP 已变化。访问本站 <a href="/ip"><code>/ip</code></a> 查看后端识别到的公网 IP，在个人中心更新白名单，或直接留空以取消 IP 限制。</p>
            </details>
            <details>
              <summary>如何查看已用次数？</summary>
              <p>个人中心会显示累计 AI 使用次数。由于使用的是你自己的 AI Key，额度以你在服务商处的账户为准。</p>
            </details>
          </div>
        </section>
    ...
    <div class="wrap">
      ...
      <main>
        <header>
          ...
          <p class="updated">生效日期：2026 年 7 月 13 日</p>
        </header>
        ...
        <article>
          ...
          <section class="section" id="sharing">
            ...
            <ul>
              <li><strong>OpenAI：</strong>当你选择 OpenAI 时，用你自己的 API Key 接收生成所需的文字和偏好。请求设置为 <code>store: false</code>，具体处理仍受 OpenAI API 数据政策约束。</li>
              <li><strong>DeepSeek：</strong>当你选择 DeepSeek 时，用你自己的 API Key 接收生成回复所需的文字和偏好，具体处理受 DeepSeek API 数据政策约束。</li>
              <li><strong>Vercel：</strong>托管后端服务，并可能处理请求 IP、网络元数据和运行日志。</li>
              <li><strong>Neon：</strong>托管用户鉴权、AI 设置和使用统计数据库。</li>
